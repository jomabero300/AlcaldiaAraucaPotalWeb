...
namespace AlcaldiaAraucaPortalWeb.Controllers.Gene
{
    ...
    public class StatesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StateId,StateName,StateB")] State state)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StateId,StateName,StateB")] State state)
        {
            if (id != state.StateId)
            {
                return NotFound();
